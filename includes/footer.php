...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        ...
        <a href="http://facebook.com/sahab.riyaj" class='active'><i class="icon fa fa-facebook"></i></a>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(0088) 186703355<br>(0088) 186703355</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">sahabuddinriyaj298@gmail.com.com</a></span>
                </div>
            </li>
